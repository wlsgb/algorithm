...
public class OpenChatting {
    public static void main(String[] args) {
        ...
        System.out.println(new OpenChatting().solution(record));
    }
    ...
    public String[] solution(String[] record) {
        ...
        for (int i = 0; i < record.length; i++) {
            ...
            String nicName = "";
            if (action.equals("Leave") == false) {
                nicName = info[2];

                // 유저 정보 저장
                userInfo.put(userId, nicName);
            }
            ...
            if (action.equals("Change")) {
                userInfo.put(actions.get("userId"), nicName);
                index--;
            }
        }
        ...
        for (int i = 0; i < users.size(); i++) {
            ...
            String msg = new StringBuffer()
                    .append(userInfo.get(user.get("userId")))
                    .append(actionMsg)
                    .toString();
