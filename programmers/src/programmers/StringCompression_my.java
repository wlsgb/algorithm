...
public class StringCompression_my {
    ...
    public static void main(String[] args) {
         ...
         * "ababcdcdababcdcd"	        9
         * "abcabcdede"	                8
         * "abcabcabcabcdededededede"	14 => 4abc3dede
         * "xababcdcdababcdcd"	        17
         */

        String s = "aabbaccc";

        System.out.println(new StringCompression_my().solution(s));
    }
    ...
    public int solution(String s) {
        ...
        for (int i = 1; i < s.length() / 2; i++) {
            int temp = compression(s, i).length();
    ...
    private String compression(String s, int i) {
        ...
        for (int j = 0; j <= len + i; j += i) {
            ...
            if (j != 0) {
                if (tempStr.equals(pattern)) {
                    count++;
                } else if (count > 1 && !tempStr.equals(pattern)) {
